...
attack_damage = 24;   // 👈 change per enemy
attack_range  = 20;  // optional but recommended
attack_speed  = 65;  // cooldown

sprite_index = spr_Elite_Swordmaster; // IMPORTANT
//==================================================
...
// 🎬 ANIMATION & SPRITES
// =====================================================
spr_idle   = spr_Elite_Swordmaster;       // Base/Idle sprite
spr_walk   = spr_Elite_Swordmaster;  // 👈 Change this to your walk sprite!
spr_attack = spr_Elite_Swordmaster;// 👈 Change this to your attack sprite!
